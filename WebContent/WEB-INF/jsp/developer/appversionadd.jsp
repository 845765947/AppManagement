			...
			<div class="x_content1">
				...
				<div class="x_content" style="display: block;">
					...
					<form class="form-horizontal form-label-left"
						action="${pageContext.request.contextPath }/appVersion/addversionsave"
						method="post" enctype="multipart/form-data">
						<input type="hidden" name="appId" name="appId"
							value="${appVersion}"> <input type="hidden"
							name="APKName" name="APKName" value="${APKName}">
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="file" class="form-control col-md-7 col-xs-12"
									name="a_downloadLink" id="a_downloadLink" required="required" /> <font color="red">${fileUploadError }</font>
							</div>
						</div>
