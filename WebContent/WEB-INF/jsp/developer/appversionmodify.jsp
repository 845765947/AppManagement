			...
			<div class="x_content1">
				...
				<div class="x_content" style="display: block;">
					...
					<form class="form-horizontal form-label-left"
						action="${pageContext.request.contextPath }/appVersion/appversionmodifysave"
						method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" id="id" value="${appVersion.id}">
						<input type="hidden" name="appId" id="appId"
							value="${appVersion.appId}"> <input type="hidden"
							name="APKName" id="APKName" value="${appVersion.APKName}">
